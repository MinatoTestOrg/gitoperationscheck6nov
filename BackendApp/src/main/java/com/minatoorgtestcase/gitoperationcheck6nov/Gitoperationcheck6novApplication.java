package com.minatoorgtestcase.gitoperationcheck6nov;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.minatoorgtestcase.gitoperationcheck6nov"})
@EnableCaching
...
public class Gitoperationcheck6novApplication {

	public static void main(String[] args) {
		SpringApplication.run(Gitoperationcheck6novApplication.class, args);
	}
